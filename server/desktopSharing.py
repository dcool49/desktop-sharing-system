...
class Ui_ScrollArea(object):
    ...
    def setupUi(self, ScrollArea):
        ...
        #self.pushButton.clicked.connect(self.ser)
        ...
        #remark : str is added in username and password
        '''
...
'''
    ...
    def retranslateUi(self, ScrollArea):
        ...
        self.pushButton.setText(_translate("ScrollArea", "Capture", None))
